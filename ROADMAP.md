...
- [ ] Port themes to VS Code (.json ColorTheme) (#16)
...
- [ ] Port themes to IntelliJ IDEA / JetBrains Suite (.icls / .jar) (#33)
...
- [ ] Port themes to Fleet (JetBrains, JSON themes) (#46)
- [ ] Port themes to Cursor (VS Code fork, ColorTheme) (#47)
- [ ] Port themes to Windsurf (VS Code fork, ColorTheme) (#48)
...
- [ ] Install script for VS Code (install.sh) (#52)
- [ ] Install script for Sublime Text (install.sh) (#53)
...
- [ ] Install script for IntelliJ IDEA / JetBrains (install.sh) (#66)
...
- [ ] Uninstall script for VS Code (uninstall.sh) (#75)
...
- [ ] Uninstall script for IntelliJ IDEA / JetBrains (uninstall.sh) (#86)
...
- [ ] README for VS Code (#97)
- [ ] README for Sublime Text (#98)
...
- [ ] README for IntelliJ IDEA / JetBrains Suite (#112)
...
- [ ] Previews for VS Code (#124)
- [ ] Previews for Sublime Text (#125)
- [ ] Previews for Vim / Neovim (#126)
- [ ] Previews for IntelliJ IDEA / JetBrains (#127)
...
- [ ] Packaging: VS Code extension (.vsix) (#142)
- [ ] Packaging: Sublime Text Package Control (#143)
- [ ] Packaging: JetBrains plugin repository (#144)
